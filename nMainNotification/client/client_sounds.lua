...
local standardVolumeOutput = 0.05;
...
------
RegisterNetEvent('GTA_Notif:PlayOnOne')
AddEventHandler('GTA_Notif:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
RegisterNetEvent('GTA_Notif:PlayOnAll')
...
------
RegisterNetEvent('GTA_Notif:PlayWithinDistance')
AddEventHandler('GTA_Notif:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
...
------
-- RegisterNetEvent LIFE_CL:Sound:PlayWithinDistanceOS (Bigmode varient of GTA_Notif:PlayWithinDistance)
--
...
-- @TODO Change sound volume based on the distance the player is away from the playOnEntity.
------
RegisterNetEvent('GTA_Notif:PlayWithinDistanceOS')
AddEventHandler('GTA_Notif:PlayWithinDistanceOS', function(playerCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(GetPlayerPed(-1))
